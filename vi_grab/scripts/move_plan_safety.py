#!/usr/bin/env python3
# -*- coding=UTF-8 -*-
#该代码是基于厂家那边改的稍微安全点，厂家那边有限位，运动效果不明显
...
def convert(x, y, z, x1, y1, z1, rx, ry, rz):
    ...
    # 机械臂末端的位姿，单位为弧度
    end_effector_pose = np.array([-0.0211, 0.01968, 0.1653, -3.125, 0.433, -2.723])
    # 将旋转矩阵和平移向量转换为齐次变换矩阵
    ...
    while run_thread:
        try:
            ...
            if cmd.lower() in ['x', 'exit', 'quit']:
                ...
                tool_name = input("请输入工具坐标系名称 [默认:hand_frame]: ") or "hand_frame"
