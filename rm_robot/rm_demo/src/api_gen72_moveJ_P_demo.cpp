...
int main(int argc, char** argv)
{
    ...
    moveJ_P_TargetPose.Pose.position.x = 0.111590;
    moveJ_P_TargetPose.Pose.position.y = -0.000059;
    moveJ_P_TargetPose.Pose.position.z = 0.817490;
    moveJ_P_TargetPose.Pose.orientation.x = 0.680844;
    moveJ_P_TargetPose.Pose.orientation.y = 0.190380;
    moveJ_P_TargetPose.Pose.orientation.z =0.680844;
    moveJ_P_TargetPose.Pose.orientation.w = 0.191464;
